...
if args.data == 'cifar10':
    ...
    args.val_batchsize = len(datasets.MNIST(
            args.dataroot, train=False, transform=transforms.Compose([
                transforms.Resize(args.imagesize),
                transforms.ToTensor(),
                add_noise,
    ...
    args.val_batchsize2 = len(datasets.FashionMNIST(
            args.dataroot, train=False, transform=transforms.Compose([
                transforms.Resize(args.imagesize),
                transforms.ToTensor(),
                add_noise,
    ...
    args.val_batchsize3 = len(datasets.FashionMNIST(
        args.dataroot, train=True, transform=transforms.Compose([
            transforms.Resize(args.imagesize),
            transforms.ToTensor(),
            add_noise,
    ...
    args.val_batchsize4 = len(datasets.KMNIST(
        args.dataroot, train=True, transform=transforms.Compose([
            transforms.Resize(args.imagesize),
            transforms.ToTensor(),
            add_noise,
    ...
    test_loader4 = torch.utils.data.DataLoader(
        ...
        batch_size=args.val_batchsize4,
        shuffle=False,
        num_workers=args.nworkers,
    )
...
def main():
    ...
    #00000000mmmmmmaainNikNik99MaaiiinMaaiiinBeBe
    #000000000000000mmmmmmmmmmmmmaaaaiinNikNik99MaaiiinMaaiiinBeBe
    ...
    #checkpoint2 = torch.load(
    #    os.path.join(os.path.join(args.save, '00000000000000mmmmmmmmmmmmmaaaaiinNikNik99MaaiiinMaaiiinBe2Be2'),
    #                 'checkpt-%04d.pth' % 10000))

    #checkpoint2 = torch.load(
    #    os.path.join(os.path.join(args.save, '0000000000000000mmmmmmmmmmmmmmaaaaiinNikNik99MaaiiinMaaiiinBeBe'),
    #                 'checkpt-%04d.pth' % 10000))
        ...
        for i, (x, y) in enumerate(train_loader):
            ...
            if lossGen < best_loss:
                ...
                utils.save_checkpoint(
                    {'state_dict': genGen.state_dict(), 'optimizer_state_dict': optimizerGen.state_dict(),
                     'args': args},
                    os.path.join(args.save, '000000000mmmmmmmaaainNikNik99MaaiiinMaaiiinBeBe'), args.nepochs)
            ...
            if (itr - 1) % 1000 == 0:
                ...
                utils.save_checkpoint(
                    {'state_dict': genGen.state_dict(), 'optimizer_state_dict': optimizerGen.state_dict(),
                     'args': args},
                    os.path.join(args.save, '00000000mmmmmmmaaainNikNik99MaaiiinMaaiiinBe2Be2'), args.nepochs)
