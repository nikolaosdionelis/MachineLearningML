...
class Options():
    ...
    def __init__(self):
        ...
        ##
        # Base
        self.parser.add_argument('--dataset', default='imageDataset', help='folder | cifar10 | mnist ')
        ...
        self.parser.add_argument('--nz', type=int, default=512, help='size of the latent z vector')
