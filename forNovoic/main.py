...
# main.py --dataset cifar --input_height=32 --c_dim=3
# --checkpoint_dir checkpoint_cifar/flow --sample_dir samples_cifar/flow
# --model_type real_nvp --log_dir logs_cifar/flow
# --prior gaussian --beta 0.5 --learning_rate 1e-3
# --lr_decay 0.99999 --alpha 1e-7 --epoch 500 --batch_size 64
# --like_reg 20.  --n_critic 5 --no_of_layers 8

# main.py --dataset cifar --input_height=32 --c_dim=3
# --model_type real_nvp --prior gaussian --beta 0.5
# --learning_rate 1e-3 --lr_decay 0.99999 --alpha 1e-7
# --epoch 500 --batch_size 64 --like_reg 20.0
# --n_critic 5 --no_of_layers 8
...
flags.DEFINE_integer("epoch", 61, "Epoch to train [25]")
flags.DEFINE_float("learning_rate", 1e-3, "Learning rate of for adam [0.0002]")
...
flags.DEFINE_string("dataset", "cifar", "The name of dataset [mnist, multi-mnist, cifar-10]")
...
flags.DEFINE_float("lr_decay", 0.99999, "learning rate decay rate")
...
flags.DEFINE_float("like_reg", 20.0, "regularizing factor for likelihood")
...
def main(_):
  ...
  flags2.DEFINE_integer("batch_size2", 64, "The size of batch images [64]")
  ...
  #flags2.DEFINE_integer("batch_size32", 5625, "The size of batch images [64]")
  flags2.DEFINE_integer("batch_size32", 5000, "The size of batch images [64]")
  #flags2.DEFINE_integer("batch_size32", 3000, "The size of batch images [64]")
  #flags2.DEFINE_integer("batch_size32", 2500, "The size of batch images [64]")
  #flags2.DEFINE_integer("input_height2", 28, "The size of image to use (will be center cropped). [108]")
  flags2.DEFINE_integer("input_height2", 32, "The size of image to use (will be center cropped). [108]")
  ...
  flags2.DEFINE_integer("output_height2", 32, "The size of the output images to produce [64]")
