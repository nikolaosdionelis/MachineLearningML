...
#torch.save(arrayFinalArray, 'filFilFilFilFilFilFileArrayFinalArray.pt')
#torch.save(labelsArrayFinalArray, 'filFilFilFilFilFilFileLabelsArrayFinalArray.pt')

#arrayFinalArray = torch.load('filFilFilFilFilFilFileArrayFinalArray.pt')
#labelsArrayFinalArray = torch.load('filFilFilFilFilFilFileLabelsArrayFinalArray.pt')

#arrayFinalArray = torch.load('/tmp/pycharm_project_950/filFilFilFilFilFilFileArrayFinalArray.pt')
#labelsArrayFinalArray = torch.load('/tmp/pycharm_project_950/filFilFilFilFilFilFileLabelsArrayFinalArray.pt')

#torch.save(arrayFinalArray, 'filFiFiFiFilFilFilFilFilFileArrayFinalArray.pt')
#torch.save(labelsArrayFinalArray, 'filFiFiFiFilFilFilFilFilFileLabelsArrayFinalArray.pt')

arrayFinalArray = torch.load('/tmp/pycharm_project_950/filFiFiFiFilFilFilFilFilFileArrayFinalArray.pt')
labelsArrayFinalArray = torch.load('/tmp/pycharm_project_950/filFiFiFiFilFilFilFilFilFileLabelsArrayFinalArray.pt')

print(arrayFinalArray.shape)
print(labelsArrayFinalArray.shape)

#print(labelsArrayFinalArray)
...
#toUse_list_bird = []
#img = Image.open('./data/images/' + list_bird[0] + '.jpg')
...
for i in range(1,list_allTotal[2]):
    ...
    #img = Image.open('../../home/ndioneli/data/images/2008_007739.jpg')
    img = Image.open('./data/images/'+list_bird[i]+'.jpg')
...
#toUse_list_boat = []
#img = Image.open('./data/images/' + list_boat[0] + '.jpg')
...
for i in range(1,list_allTotal[3]):
    ...
    #img = Image.open('../../home/ndioneli/data/images/2008_007739.jpg')
    img = Image.open('./data/images/'+list_boat[i]+'.jpg')
...
#toUse_list_bottle = []
#img = Image.open('./data/images/' + list_bottle[0] + '.jpg')
...
for i in range(1,list_allTotal[4]):
    ...
    #img = Image.open('../../home/ndioneli/data/images/2008_007739.jpg')
    img = Image.open('./data/images/'+list_bottle[i]+'.jpg')
...
#toUse_list_bus = []
#img = Image.open('./data/images/' + list_bus[0] + '.jpg')
...
for i in range(1,list_allTotal[5]):
    ...
    #img = Image.open('../../home/ndioneli/data/images/2008_007739.jpg')
    img = Image.open('./data/images/'+list_bus[i]+'.jpg')
...
#toUse_list_car = []
#img = Image.open('./data/images/' + list_car[0] + '.jpg')
...
for i in range(1,list_allTotal[6]):
    ...
    #img = Image.open('../../home/ndioneli/data/images/2008_007739.jpg')
    img = Image.open('./data/images/'+list_car[i]+'.jpg')
...
#toUse_list_cat = []
#img = Image.open('./data/images/' + list_cat[0] + '.jpg')
...
for i in range(1,list_allTotal[7]):
    ...
    #img = Image.open('../../home/ndioneli/data/images/2008_007739.jpg')
    img = Image.open('./data/images/'+list_cat[i]+'.jpg')
...
#toUse_list_chair = []
#img = Image.open('./data/images/' + list_chair[0] + '.jpg')
...
for i in range(1,list_allTotal[8]):
    ...
    #img = Image.open('../../home/ndioneli/data/images/2008_007739.jpg')
    img = Image.open('./data/images/'+list_chair[i]+'.jpg')
...
#toUse_list_cow = []
#img = Image.open('./data/images/' + list_cow[0] + '.jpg')
...
for i in range(1,list_allTotal[9]):
    ...
    #img = Image.open('../../home/ndioneli/data/images/2008_007739.jpg')
    img = Image.open('./data/images/'+list_cow[i]+'.jpg')
...
#img = Image.open('./data/images/' + list_diningtable[0] + '.jpg')
...
for i in range(1,list_allTotal[10]):
    ...
    #img = Image.open('../../home/ndioneli/data/images/2008_007739.jpg')
    img = Image.open('./data/images/'+list_diningtable[i]+'.jpg')
...
#toUse_list_dog = []
#img = Image.open('./data/images/' + list_dog[0] + '.jpg')
...
for i in range(1,list_allTotal[11]):
    ...
    #img = Image.open('../../home/ndioneli/data/images/2008_007739.jpg')
    img = Image.open('./data/images/'+list_dog[i]+'.jpg')
...
#toUse_list_horse = []
#img = Image.open('./data/images/' + list_horse[0] + '.jpg')
...
for i in range(1,list_allTotal[12]):
    ...
    #img = Image.open('../../home/ndioneli/data/images/2008_007739.jpg')
    img = Image.open('./data/images/'+list_horse[i]+'.jpg')
...
#img = Image.open('./data/images/' + list_motorbike[0] + '.jpg')
...
for i in range(1,list_allTotal[13]):
    ...
    #img = Image.open('../../home/ndioneli/data/images/2008_007739.jpg')
    img = Image.open('./data/images/'+list_motorbike[i]+'.jpg')
...
#toUse_list_person = []
#img = Image.open('./data/images/' + list_person[0] + '.jpg')
...
for i in range(1,list_allTotal[14]):
    ...
    #img = Image.open('../../home/ndioneli/data/images/2008_007739.jpg')
    img = Image.open('./data/images/'+list_person[i]+'.jpg')
...
#img = Image.open('./data/images/' + list_pottedplant[0] + '.jpg')
...
for i in range(1,list_allTotal[15]):
    ...
    #img = Image.open('../../home/ndioneli/data/images/2008_007739.jpg')
    img = Image.open('./data/images/'+list_pottedplant[i]+'.jpg')
...
#toUse_list_sheep = []
#img = Image.open('./data/images/' + list_sheep[0] + '.jpg')
...
for i in range(1,list_allTotal[16]):
    ...
    #img = Image.open('../../home/ndioneli/data/images/2008_007739.jpg')
    img = Image.open('./data/images/'+list_sheep[i]+'.jpg')
...
#toUse_list_sofa = []
#img = Image.open('./data/images/' + list_sofa[0] + '.jpg')
...
for i in range(1,list_allTotal[17]):
    ...
    #img = Image.open('../../home/ndioneli/data/images/2008_007739.jpg')
    img = Image.open('./data/images/'+list_sofa[i]+'.jpg')
...
#toUse_list_train = []
#img = Image.open('./data/images/' + list_train[0] + '.jpg')
...
for i in range(1,list_allTotal[18]):
    ...
    #img = Image.open('../../home/ndioneli/data/images/2008_007739.jpg')
    img = Image.open('./data/images/'+list_train[i]+'.jpg')
...
#img = Image.open('./data/images/' + list_tvmonitor[0] + '.jpg')
...
for i in range(1,list_allTotal[19]):
    ...
    #img = Image.open('../../home/ndioneli/data/images/2008_007739.jpg')
    img = Image.open('./data/images/'+list_tvmonitor[i]+'.jpg')
...
#arrayFinalArray = torch.empty(676+571+773+516+768+430+1229+1084+1298+309+641+1297+483+536+4374+568+326+695+550+595, 3072)
#labelsArrayFinalArray = torch.empty(676+571+773+516+768+430+1229+1084+1298+309+641+1297+483+536+4374+568+326+695+550+595)

arrayFinalArray = toUse_list_tvmonitor.clone()
labelsArrayFinalArray = 19*torch.ones(595)

#labelsArrayFinalArray = 19*torch.ones(595)
#labelsArrayFinalArray = torch.cat((labelsArrayFinalArray, 19 * torch.ones(list_allTotal[-1])), 0)

for i in range(19):
    #arrayFinalArray = torch.cat((arrayFinalArray, toUse_list_train), 0)

    #labelsArrayFinalArray = torch.cat((labelsArrayFinalArray, 19*torch.ones(550)), 0)
    #labelsArrayFinalArray = torch.cat((labelsArrayFinalArray, 19 * torch.ones(list_allTotal[-1])), 0)

    #labelsArrayFinalArray = torch.cat((labelsArrayFinalArray, 19 * torch.ones(list_allTotal[-1-i-1])), 0)
    labelsArrayFinalArray = torch.cat((labelsArrayFinalArray, (19-i-1) * torch.ones(list_allTotal[-1 - i - 1])), 0)

arrayFinalArray = torch.cat((arrayFinalArray, toUse_list_train), 0)

arrayFinalArray = torch.cat((arrayFinalArray, toUse_list_sofa), 0)
arrayFinalArray = torch.cat((arrayFinalArray, toUse_list_sheep), 0)

arrayFinalArray = torch.cat((arrayFinalArray, toUse_list_pottedplant), 0)
arrayFinalArray = torch.cat((arrayFinalArray, toUse_list_person), 0)

arrayFinalArray = torch.cat((arrayFinalArray, toUse_list_motorbike), 0)
arrayFinalArray = torch.cat((arrayFinalArray, toUse_list_horse), 0)

arrayFinalArray = torch.cat((arrayFinalArray, toUse_list_dog), 0)
arrayFinalArray = torch.cat((arrayFinalArray, toUse_list_diningtable), 0)

arrayFinalArray = torch.cat((arrayFinalArray, toUse_list_cow), 0)
arrayFinalArray = torch.cat((arrayFinalArray, toUse_list_chair), 0)

arrayFinalArray = torch.cat((arrayFinalArray, toUse_list_cat), 0)
arrayFinalArray = torch.cat((arrayFinalArray, toUse_list_car), 0)

arrayFinalArray = torch.cat((arrayFinalArray, toUse_list_bus), 0)
arrayFinalArray = torch.cat((arrayFinalArray, toUse_list_bottle), 0)

arrayFinalArray = torch.cat((arrayFinalArray, toUse_list_boat), 0)
arrayFinalArray = torch.cat((arrayFinalArray, toUse_list_bird), 0)

arrayFinalArray = torch.cat((arrayFinalArray, toUse_list_bicycle), 0)
arrayFinalArray = torch.cat((arrayFinalArray, toUse_list_aeroplane), 0)

print('')
print(arrayFinalArray.shape)

print(labelsArrayFinalArray.shape)
#print(torch.sum(list_allTotal))

torch.save(arrayFinalArray, 'filFiFiFiFilFilFilFilFilFileArrayFinalArray.pt')
torch.save(labelsArrayFinalArray, 'filFiFiFiFilFilFilFilFilFileLabelsArrayFinalArray.pt')

#print(torch.sum(list_allTotal))
print(np.sum(list_allTotal))

# torch.Size([17719, 3072])
# torch.Size([17719])
