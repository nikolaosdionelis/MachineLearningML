...
class DCGAN(object):
  ...
  def build_model(self):
    ...
    #print(inputs_tr_flow.shape)
    #print(np.shape(inputs_tr_flow))

    #print(inputs_tr_flow.eval())
    #asdfsdkfz
  ...
  def train(self, config):
    ...
    if counter > 1:
      ...
      # use: np.load(training_image_names_array, allow_pickle=True)
