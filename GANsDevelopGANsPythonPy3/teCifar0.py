...
#parser.add_argument('--resume', type=str, default='./cifarFourEpochs/most_recent.pth')
parser.add_argument('--resume', type=str, default='./cifarUseCifar/experiment1/moMoMoFor3FoFor3_modeModels/nikCopyFor3moFor3MoMosFor3_moMoFor3MoMosMostReceRecent.pth')

# os.path.join(args.save, 'moMoMoFor3FoFor3_modeModels', 'nikCopyFor3moFor3MoMosFor3_moMoFor3MoMosMostReceRecent.pth'))
# use: os.path.join(args.save, 'moMoMoFor3FoFor3_modeModels', 'nikCopyFor3moFor3MoMosFor3_moMoFor3MoMosMostReceRecent.pth'))
...
def main():
    ...
    def plot_roc_curve(fpr, tpr, auroc21):
        ...
        #plt.savefig('nik000NikNikROC_MainROC.png', bbox_inches='tight')
        plt.savefig('cifarFor3MainROC.png', bbox_inches='tight')
    ...
    def plot_pr_curve(fpr, tpr, auroc21):
        ...
        #plt.savefig('nik000NikNikPR_MainPR.png', bbox_inches='tight')
        plt.savefig('cifarFor3MainPR.png', bbox_inches='tight')
    ...
    def plot_roc_curve2(fpr, tpr, auroc21, fpr2, tpr2, auroc212):
        ...
        #plt.savefig('nikNik00000nikNikNikROC_MainROC.png', bbox_inches='tight')
        plt.savefig('cifarFor3MainROCPR.png', bbox_inches='tight')
