...
#parser.add_argument('--resume', type=str, default=None)
#parser.add_argument('--resume', type=str, default='./experiments/mnist/models/0201mosMost_recent.pth')
...
def main():
    ...
    for epoch in range(args.begin_epoch, args.nepochs):
        ...
        #    'ema': ema,
        #    'test_bpd': test_bpd,
        #}, os.path.join(args.save, 'models', '0201mosMost_recent.pth'))
        ...
        #    'ema': ema,
        #    'test_bpd': test_bpd,
        #}, os.path.join(args.save, 'models', '03030330201mosMost_recent.pth'))
        ...
        #    'ema': ema,
        #    'test_bpd': test_bpd,
        #}, os.path.join(args.save, 'models', 'for4_for4_MoostReecent.pth'))
        ...
        #    'ema': ema,
        #    'test_bpd': test_bpd,
        #}, os.path.join(args.save, 'models', 'foFor4_foFor4_MoosstReeccent.pth'))
        ...
        #    'ema': ema,
        #    'test_bpd': test_bpd,
        #}, os.path.join(args.save, 'models', 'foFoForFor4_foForFor4_MoForMoFor4_mosstReeccent.pth'))
        ...
        torch.save({
            ...
            'ema': ema,
            'test_bpd': test_bpd,
        }, os.path.join(args.save, 'models', 'foFoFoFoForFor4_foForFor4_moMoForMoFor4_mosstReeccent.pth'))
