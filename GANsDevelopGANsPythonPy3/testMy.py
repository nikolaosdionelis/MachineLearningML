...
def main():
    ...
    def plot_roc_curve(fpr, tpr, auroc21):
        ...
        plt.savefig('foFoFor4_9900000001NikNikROC_MainROC.png', bbox_inches='tight')
    ...
    def plot_pr_curve(fpr, tpr, auroc21):
        ...
        plt.savefig('foFor4_foFor4_9900000001NikNikPR_MainPR.png', bbox_inches='tight')
    ...
    def plot_roc_curve2(fpr, tpr, auroc21, fpr2, tpr2, auroc212):
        ...
        #plt.savefig('nikNik00000nikNikNikROC_MainROC.png', bbox_inches='tight')
        plt.savefig('foFor4_nikNikFor4_99000001nikNikNikROCPR_MainROCPR.png', bbox_inches='tight')
