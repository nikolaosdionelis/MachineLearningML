...
# it includes the proposed BDSGM.
...
def main():
    ...
    for epoch in range(args.begin_epoch, args.nepochs):
        ...
        epoch_loss = running_loss / len(datasets.CIFAR10(args.dataroot, train=True, transform=transform_train))
        ...
        if test_bpd < best_test_bpd:
            ...
            utils.save_checkpoint({
                ...
                'ema': ema,
                'test_bpd': test_bpd,
            }, os.path.join(args.save, 'moMoModels'), epoch, last_checkpoints, num_checkpoints=5)
        ...
        torch.save({
            ...
            'ema': ema,
            'test_bpd': test_bpd,
        }, os.path.join(args.save, 'models', '010mmoosttMoosttRecentt.pth'))
        ...
        torch.save({
            ...
            'ema': ema,
            'test_bpd': test_bpd,
        }, os.path.join(args.save, 'models', '0mmoosttMoosttRecentt.pth'))
        ...
        torch.save({
            ...
            'ema': ema,
            'test_bpd': test_bpd,
        }, os.path.join(args.save, 'models', 'moosttMoosttRecentt.pth'))
