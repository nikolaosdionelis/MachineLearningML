...
def main():
    ...
    #checkpoint2 = torch.load(
    #   os.path.join(os.path.join(args.save, '0000000mmmmmainNikNik99MaaiiinMaaiiinBeBe'), 'checkpt-%04d.pth' % 1000))
    ...
    #checkpoint2 = torch.load(
    #    os.path.join(os.path.join(args.save, '000000011mmmmmainNikNik99MaaiiinMaaiiinBeBe'), 'checkpt-%04d.pth' % 1000))

    #checkpoint2 = torch.load(
    #    os.path.join(os.path.join(args.save, '0000000111mmmmmmainNikNik99MaaiiinMaaiiinBeBe'), 'checkpt-%04d.pth' % 10000))

    #checkpoint2 = torch.load(
    #    os.path.join(os.path.join(args.save, '00000001111mmmmmmmaainNikNik99MaaiiinMaaiiinBeBe'),
    #                 'checkpt-%04d.pth' % 10000))

    #checkpoint2 = torch.load(
    #    os.path.join(os.path.join(args.save, '000000011111mmmmmmmmaainNikNik99MaaiiinMaaiiinBeBe'),
    #                 'checkpt-%04d.pth' % 10000))

    #checkpoint2 = torch.load(
    #    os.path.join(os.path.join(args.save, '00000000111111mmmmmmmmaainNikNik99MaaiiinMaaiiinBeBe'),
    #                 'checkpt-%04d.pth' % 10000))

    #checkpoint2 = torch.load(
    #    os.path.join(os.path.join(args.save, '0000000001111111mmmmmmmmaainNikNik99MaaiiinMaaiiinBeBe'),
    #                 'checkpt-%04d.pth' % 10000))

    #checkpoint2 = torch.load(
    #    os.path.join(os.path.join(args.save, '000000000011111111mmmmmmmmaainNikNik99MaaiiinMaaiiinBeBe'),
    #                 'checkpt-%04d.pth' % 10000))

    #checkpoint2 = torch.load(
    #    os.path.join(os.path.join(args.save, '00000000000111111111mmmmmmmmaainNikNik99MaaiiinMaaiiinBeBe'),
    #                 'checkpt-%04d.pth' % 10000))
    ...
    checkpoint2 = torch.load(
        os.path.join(os.path.join(args.save, '0000000000000111111111111mmmmmmmmaainNikNik99MaaiiinMaaiiinBe2Be2'),
                     'checkpt-%04d.pth' % 10000))
        ...
        for i, (x, y) in enumerate(train_loader):
            ...
            if lossGen < best_loss:
                ...
                utils.save_checkpoint(
                    {'state_dict': genGen.state_dict(), 'optimizer_state_dict': optimizerGen.state_dict(),
                     'args': args},
                    os.path.join(args.save, '0000000000000001111111111111mmmmmmmmaainNikNik99MaaiiinMaaiiinBeBe'), args.nepochs)
            ...
            if (itr - 1) % 1000 == 0:
                ...
                utils.save_checkpoint(
                    {'state_dict': genGen.state_dict(), 'optimizer_state_dict': optimizerGen.state_dict(),
                     'args': args},
                    os.path.join(args.save, '000000000000001111111111111mmmmmmmmaainNikNik99MaaiiinMaaiiinBe2Be2'), args.nepochs)
    ...
    #plt.savefig('00000ffffffoooFFoo.png', bbox_inches='tight')
    #plt.savefig('000000fffffffoooFFoo.png', bbox_inches='tight')

    #plt.savefig('0000000ffffffffoooFFoo.png', bbox_inches='tight')
    #plt.savefig('00000000fffffffffoooFFoo.png', bbox_inches='tight')

    #plt.savefig('000000000ffffffffffoooFFoo.png', bbox_inches='tight')
    #plt.savefig('0000000000fffffffffffoooFFoo.png', bbox_inches='tight')
    plt.savefig('00000000000ffffffffffffoooFFoo.png', bbox_inches='tight')
