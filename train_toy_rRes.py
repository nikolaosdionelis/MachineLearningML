...
#parser.add_argument('--niters2', type=int, default=100)
parser.add_argument('--niters2', type=int, default=1500)
...
if __name__ == '__main__':
    ...
    #for itr in range(1, args.niters + 1):
        ...
        if (itr-1)%300 == 0:
            ...
            utils.save_checkpoint({'state_dict': model.state_dict()}, os.path.join(args.save, 'myModels'), itr)
            #utils.save_checkpoint({'state_dict': model.state_dict()}, os.path.join(args.save, 'myModels'), args.niters2)
