...
parser.add_argument('--save', default='experiments/mnist', type=str)
...
if args.data == 'cifar10':
    ...
    traTraTraTrain_loader = datasets.MNIST(
    ...
    mnist = traTraTraTrain_loader

    idx = mnist.mnist.train_labels == 0
    # idx += mnist.mnist.train_labels == 2
    # idx += mnist.mnist.train_labels == 3
    # idx += mnist.mnist.train_labels == 4
    # idx += mnist.mnist.train_labels == 5
    # idx += mnist.mnist.train_labels == 6
    # idx += mnist.mnist.train_labels == 7
    # idx += mnist.mnist.train_labels == 8
    # idx += mnist.mnist.train_labels == 9
    mnist.mnist.train_labels = mnist.mnist.train_labels[idx]
    mnist.mnist.train_data = mnist.mnist.train_data[idx]
    ...
    idx = mnist2.mnist.train_labels == 1
    # idx += mnist.mnist.train_labels == 2
    # idx += mnist.mnist.train_labels == 3
    # idx += mnist.mnist.train_labels == 4
    # idx += mnist.mnist.train_labels == 5
    ...
    # idx += mnist.mnist.train_labels == 8
    # idx += mnist.mnist.train_labels == 9
    mnist2.mnist.train_labels = mnist2.mnist.train_labels[idx]
    mnist2.mnist.train_data = mnist2.mnist.train_data[idx]
    ...
    idx = mnist2.mnist.train_labels == 2
    # idx += mnist.mnist.train_labels == 2
    # idx += mnist.mnist.train_labels == 3
    # idx += mnist.mnist.train_labels == 4
    # idx += mnist.mnist.train_labels == 5
    ...
    idx = mnist2.mnist.train_labels == 3
    # idx += mnist.mnist.train_labels == 2
    # idx += mnist.mnist.train_labels == 3
    # idx += mnist.mnist.train_labels == 4
    # idx += mnist.mnist.train_labels == 5
    ...
    idx = mnist2.mnist.train_labels == 4
    # idx += mnist.mnist.train_labels == 2
    # idx += mnist.mnist.train_labels == 3
    # idx += mnist.mnist.train_labels == 4
    # idx += mnist.mnist.train_labels == 5
    ...
    idx = mnist2.mnist.train_labels == 5
    # idx += mnist.mnist.train_labels == 2
    # idx += mnist.mnist.train_labels == 3
    # idx += mnist.mnist.train_labels == 4
    # idx += mnist.mnist.train_labels == 5
    ...
    idx = mnist2.mnist.train_labels == 6
    # idx += mnist.mnist.train_labels == 2
    # idx += mnist.mnist.train_labels == 3
    # idx += mnist.mnist.train_labels == 4
    # idx += mnist.mnist.train_labels == 5
    ...
    idx = mnist2.mnist.train_labels == 7
    # idx += mnist.mnist.train_labels == 2
    # idx += mnist.mnist.train_labels == 3
    # idx += mnist.mnist.train_labels == 4
    # idx += mnist.mnist.train_labels == 5
    ...
    idx = mnist2.mnist.train_labels == 8
    # idx += mnist.mnist.train_labels == 2
    # idx += mnist.mnist.train_labels == 3
    # idx += mnist.mnist.train_labels == 4
    # idx += mnist.mnist.train_labels == 5
    ...
    idx = mnist2.mnist.train_labels == 9
    # idx += mnist.mnist.train_labels == 2
    # idx += mnist.mnist.train_labels == 3
    # idx += mnist.mnist.train_labels == 4
    # idx += mnist.mnist.train_labels == 5
    ...
    '''
    #idx = traTraTraTrain_loader.mnist.targets == 0
    #idx += traTraTraTrain_loader.mnist.targets == 1

    idx = traTraTraTrain_loader.mnist.targets == 1
    idx += traTraTraTrain_loader.mnist.targets == 2
    idx += traTraTraTrain_loader.mnist.targets == 3
    idx += traTraTraTrain_loader.mnist.targets == 4
    idx += traTraTraTrain_loader.mnist.targets == 5
    idx += traTraTraTrain_loader.mnist.targets == 6
    idx += traTraTraTrain_loader.mnist.targets == 7
    idx += traTraTraTrain_loader.mnist.targets == 8
    idx += traTraTraTrain_loader.mnist.targets == 9
    traTraTraTrain_loader.mnist.targets = traTraTraTrain_loader.mnist.targets[idx]
    traTraTraTrain_loader.mnist.data = traTraTraTrain_loader.mnist.data[idx]
    '''

    #print(len(traTraTraTrain_loader))
    #adsfasdfasfasdf

    #idx = traTraTraTrain_loader.train_labels == 0
    #traTraTraTrain_loader.train_labels = traTraTraTrain_loader.train_labels[idx]
    #traTraTraTrain_loader.train_data = traTraTraTrain_loader.train_data[idx]
