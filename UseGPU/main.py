...
#parser.add_argument('--ckptG', type=str, default='./presgan_laMyLambda_0.0001/netG_presgan_mnist_epoch_.pth', help='a given checkpoint file for generator')
#parser.add_argument('--ckptD', type=str, default='./presgan_laMyLambda_0.0001/netD_presgan_mnist_epoch_.pth', help='a given checkpoint file for discriminator')
...
if args.model == 'presgan':
    ...
    #args.results_folder = args.model + '_lambda_' + str(args.lambda_)
    #args.results_folder = args.model + '_laMyLambda_' + str(args.lambda_)

    #args.results_folder = args.model + '_laMyLambda_' + str(args.lambda_)

    #args.results_folder = args.model + '_laMyLambda_' + str(args.lambda_)
    #args.results_folder = args.model + '_worWorkLaMyLambda_' + str(args.lambda_)

    #args.results_folder = args.model + '_worWorkLaMyLambda_' + str(args.lambda_)
    #args.results_folder = args.model + '_worWorWorkLaMyLambda_' + str(args.lambda_)

    #args.results_folder = args.model + '_worWorWorkLaMyLambda_' + str(args.lambda_)
    args.results_folder = args.model + '_woWorWorWorkLaMyLambda_' + str(args.lambda_)
