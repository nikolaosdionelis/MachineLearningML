...
def main():
    ...
    #0000000000000000mmmmmmmmmmmmmmmaaaaiinNikNik99MaaiiinMaaiiinBe2Be2
    #00000000000000000mmmmmmmmmmmmmmmmaaaaaiinNikNik99MaaiiinMaaiiinBe2Be2
        ...
        for i, (x, y) in enumerate(train_loader):
            ...
            with torch.no_grad():
                ...
                for i in range(args.batchsize):
                    ...
                    secondSecSec_term_loss32 = torch.empty(9, device=device)
            ...
            plt.savefig('saveSaSaSaveStore_second_term_loss32.png', bbox_inches='tight')
            ...
            if lossGen < best_loss:
                ...
                utils.save_checkpoint(
                    {'state_dict': genGen.state_dict(), 'optimizer_state_dict': optimizerGen.state_dict(),
                     'args': args},
                    os.path.join(args.save, '000000000000000000mmmmmmmmmmmmmmmmaaaaaiinNikNik99MaaiiinMaaiiinBeBe'), args.nepochs)
            ...
            if (itr - 1) % 1000 == 0:
                ...
                utils.save_checkpoint(
                    {'state_dict': genGen.state_dict(), 'optimizer_state_dict': optimizerGen.state_dict(),
                     'args': args},
                    os.path.join(args.save, '00000000000000000mmmmmmmmmmmmmmmmaaaaaiinNikNik99MaaiiinMaaiiinBe2Be2'), args.nepochs)
