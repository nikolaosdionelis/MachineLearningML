...
if __name__ == '__main__':
    ...
    #checkpoint = torch.load(os.path.join(os.path.join(args.save, '00models'), 'checkpt-5000.pth'))
    #model.load_state_dict(checkpoint['state_dict'])
    #model = model.to(device)

    """
    checkpoint = torch.load(os.path.join(os.path.join(args.save, '0models'), 'checkpt-5000.pth'))
    #checkpoint = torch.load(os.path.join(os.path.join(args.save, '00models'), 'checkpt-5000.pth'))
    ...
    #for itr in range(1, 500000):
        ...
        if itr % args.viz_freq == 0:
            with torch.no_grad():
                ...
                fig_filename = os.path.join(args.save, '0figs', '{:04d}.jpg'.format(itr))
                print('')
                ...
                utils.save_checkpoint({'state_dict': model.state_dict(), 'optimizer_state_dict': optimizer.state_dict()},
                    os.path.join(args.save, '000mmoodels'), args.niters)
    ...
    #utils.save_checkpoint({'state_dict': model.state_dict(), 'optimizer_state_dict': optimizer.state_dict()},
    #                      os.path.join(args.save, '00models'), args.niters)

    #checkpoint = torch.load(os.path.join(os.path.join(args.save, '00models'), 'checkpt-5000.pth'))
    #checkpoint = torch.load(os.path.join(os.path.join(args.save, '0models'), 'checkpt-5000.pth'))

    #checkpoint = torch.load(os.path.join(os.path.join(args.save, '000mmoodels'), 'checkpt-5000.pth'))
    ...
    utils.save_checkpoint({'state_dict': model.state_dict(), 'optimizer_state_dict': optimizer.state_dict()},
                          os.path.join(args.save, '00000mmmooodels'), args.niters)
    ...
    checkpoint2 = torch.load(os.path.join(os.path.join(args.save, '000000000000NNNNN0IRN_bs64models'), 'checkpt-%04d.pth' % args.niters2))
    genGen.load_state_dict(checkpoint2['state_dict'])
    ...
    for itr in range(1, args.niters2 + 1):
        ...
        if (itr-1) % 500 == 0:
            with torch.no_grad():
                ...
                plt.text(7.3, -4.5 + 0.2, 'G(z) = IResNet, B(z) = 2-8-8-8-2, {} epochs'.format(itr-1),
                         verticalalignment='bottom', horizontalalignment='right', fontsize=10.5)

                plt.text(7.3, -4.0 + 0.2, 'x ~ N(2), x std = 0.35, l1 = 0.3, l2 = 0.025, lr = {}'.format(args.lr),
                         verticalalignment='bottom', horizontalalignment='right', fontsize=10.5)
                ...
                fig_filename = os.path.join(args.save, '00000000000000NNNNN0IRN_bs64figs', 'ffii{:04d}.jpg'.format(itr))
                print('')
                ...
                utils.save_checkpoint({'state_dict': genGen.state_dict(), 'optimizer_state_dict': optimizerGen.state_dict(), 'args': args},
                    os.path.join(args.save, '00000000000000NNNNN0IRN_bs64models'), args.niters2)
        ...
        if lossGen < best_loss:
            ...
            utils.save_checkpoint({'state_dict': genGen.state_dict(), 'optimizer_state_dict': optimizerGen.state_dict(), 'args': args},
                                  os.path.join(args.save, '00000000000000NNNNN0IRN_bs64modelsBest'), args.niters2)
