...
#parser.add_argument('--resume', type=str, default='./experiments/mnist/models/most_recent.pth')
#parser.add_argument('--resume', type=str, default='./experiments/mnist/models/01mosMost_recent.pth')
...
def main():
    ...
    for epoch in range(args.begin_epoch, args.nepochs):
        ...
        #    'ema': ema,
        #    'test_bpd': test_bpd,
        #}, os.path.join(args.save, 'models', '01mosMost_recent.pth'))
        ...
        #    'ema': ema,
        #    'test_bpd': test_bpd,
        #}, os.path.join(args.save, 'models', '00014141moMost_recent.pth'))
        ...
        #    'ema': ema,
        #    'test_bpd': test_bpd,
        #}, os.path.join(args.save, 'models', 'foFoFor2_mosMostFoFor2_recRecentFoFor2.pth'))
        ...
        #    'ema': ema,
        #    'test_bpd': test_bpd,
        #}, os.path.join(args.save, 'models', 'fofoFofoFor2_mosMoMosstFoFor2_recRecentFoFor2.pth'))
        ...
        torch.save({
            ...
            'ema': ema,
            'test_bpd': test_bpd,
        }, os.path.join(args.save, 'models', 'fofoFofoFor2_moMosMoMosstFoFor2_recRecentFoFor2.pth'))
