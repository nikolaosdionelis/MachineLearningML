...
#parser.add_argument('--resume', type=str, default='./experiment1/for8for8For8For8For8ModeFor8Models/for8for8For8FoFor8For8MostReceFor8reRecent.pth')
parser.add_argument('--resume', type=str, default='./fromEddieCifar2/mostFoFor2For2For2recenntt.pth')
...
def main():
    ...
    def plot_roc_curve(fpr, tpr, auroc21):
        ...
        # plt.savefig('nik000NikNikROC_MainROC.png', bbox_inches='tight')
        plt.savefig('cifarFor2ROC.png', bbox_inches='tight')
    ...
    def plot_pr_curve(fpr, tpr, auroc21):
        ...
        # plt.savefig('nik000NikNikPR_MainPR.png', bbox_inches='tight')
        plt.savefig('cifarFor2PR.png', bbox_inches='tight')
    ...
    def plot_roc_curve2(fpr, tpr, auroc21, fpr2, tpr2, auroc212):
        ...
        # plt.savefig('nikNik00000nikNikNikROC_MainROC.png', bbox_inches='tight')
        plt.savefig('cifarFor2ROCPR.png', bbox_inches='tight')
