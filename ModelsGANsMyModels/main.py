...
#parser.add_argument('--ckptG', type=str, default='', help='a given checkpoint file for generator')
parser.add_argument('--ckptG', type=str, default='./presgan_lambda_0.0001/netG_presgan_mnist_epoch_28.pth', help='a given checkpoint file for generator')
...
parser.add_argument('--save_ckpt_every', type=int, default=5, help='when to save checkpoint')
parser.add_argument('--save_imgs_every', type=int, default=5, help='when to save generated images')
