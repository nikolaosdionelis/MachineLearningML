...
#parser.add_argument('--resume', type=str, default=None)
#parser.add_argument('--resume', type=str, default='./experiment1/models/for6_mosRecenFor6.pth')

#parser.add_argument('--resume', type=str, default='./experiment1/models/for6_mosRecenFor6.pth')
#parser.add_argument('--resume', type=str, default='./experiment1/models/foFor6_mosRecenFor6.pth')

#parser.add_argument('--resume', type=str, default='./experiment1/models/foFor6_mosRecenFor6.pth')
#parser.add_argument('--resume', type=str, default='./experiment1/moModels/foFor6_mosRecenFor6.pth')

#parser.add_argument('--resume', type=str, default='./experiment1/moModels/foFor6_mosRecenFor6.pth')
#parser.add_argument('--resume', type=str, default='./experiment1/moMoModels/foForFor6_mosFor6_mosMosRecenFor6.pth')

#parser.add_argument('--resume', type=str, default='./experiment1/moMoModels/foForFor6_mosFor6_mosMosRecenFor6.pth')
#parser.add_argument('--resume', type=str, default='./experiment1/moMoModels/foForFor6_mosMosMostFor6_mosMosRecenFor6.pth')

#parser.add_argument('--resume', type=str, default='./experiment1/moMoModels/foForFor6_mosMosMostFor6_mosMosRecenFor6.pth')
#parser.add_argument('--resume', type=str, default='./experiment1/moMoModels/checkpt-0006.pth')

#parser.add_argument('--resume', type=str, default='./experiment1/moMoModels/checkpt-0006.pth')
parser.add_argument('--resume', type=str, default='./experiment1/00moMoModels/checkpt-0002.pth')

# os.path.join(args.save, '00moMoModels', 'for6_mosMosMostFor6_mosMosRecenFor6.pth'))
# use: os.path.join(args.save, '00moMoModels', 'for6_mosMosMostFor6_mosMosRecenFor6.pth'))

# os.path.join(args.save, 'moMoModels', 'foForFor6_mosMosMostFor6_mosMosRecenFor6.pth'))
# use: os.path.join(args.save, 'moMoModels', 'foForFor6_mosMosMostFor6_mosMosRecenFor6.pth'))

# os.path.join(args.save, 'moMoModels', 'foForFor6_mosFor6_mosMosRecenFor6.pth'))
# use: os.path.join(args.save, 'moMoModels', 'foForFor6_mosFor6_mosMosRecenFor6.pth'))

# os.path.join(args.save, 'moModels', 'foFor6_mosRecenFor6.pth'))
# use: os.path.join(args.save, 'moModels', 'foFor6_mosRecenFor6.pth'))
    ...
    for epoch in range(args.begin_epoch, args.nepochs):
        ...
        if test_bpd < best_test_bpd:
            ...
            utils.save_checkpoint({
                ...
                'ema': ema,
                'test_bpd': test_bpd,
            }, os.path.join(args.save, '000modModModels'), epoch, last_checkpoints, num_checkpoints=5)
        ...
        #    'ema': ema,
        #    'test_bpd': test_bpd,
        #}, os.path.join(args.save, 'models', 'for6_mosRecenFor6.pth'))
        ...
        torch.save({
            ...
            'ema': ema,
            'test_bpd': test_bpd,
        }, os.path.join(args.save, '000modModModels', 'foFor6_mosMosMostFor6_mosMosRecenFor6.pth'))
