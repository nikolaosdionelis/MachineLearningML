...
#netG_presgan_mnist_epoch_25.pth
...
#parser.add_argument('--ckptG', type=str, default='../presgan_woMyNikMyNikWorkNikNikLambda_0.0001/netG_presgan_mnist_epoch_740.pth',
#                    help='a given checkpoint file for generator')
...
parser.add_argument('--save_ckpt_every', type=int, default=10, help='when to save checkpoint')
parser.add_argument('--save_imgs_every', type=int, default=10, help='when to save generated images')
...
if args.model == 'presgan':
    ...
    #args.results_folder = args.model + '_lambda_' + str(args.lambda_)
    #args.results_folder = args.model + '_nikNikLambda_' + str(args.lambda_)

    #args.results_folder = args.model + '_nikNikLambda_' + str(args.lambda_)
    #args.results_folder = args.model + '_woWorkNikNikLambda_' + str(args.lambda_)

    #args.results_folder = args.model + '_woWorkNikNikLambda_' + str(args.lambda_)
    #args.results_folder = args.model + '_woNikWorkNikNikLambda_' + str(args.lambda_)

    #args.results_folder = args.model + '_woNikWorkNikNikLambda_' + str(args.lambda_)
    #args.results_folder = args.model + '_woMyNikMyNikWorkNikNikLambda_' + str(args.lambda_)

    #args.results_folder = args.model + '_woMyNikMyNikWorkNikNikLambda_' + str(args.lambda_)

    #args.results_folder = args.model + '_woMyNikMyNikWorkNikNikLambda_' + str(args.lambda_)
    args.results_folder = args.model + '_dioDionelisWoMyNikMyNikWorkNikNikLambda_' + str(args.lambda_)
