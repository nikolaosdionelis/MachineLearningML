...
def main():
    ...
    #checkpoint2 = torch.load(
    #    os.path.join(os.path.join(args.save, '00000000000mmmmmmmmmaaaiinnNikNik99MaaiiinMaaiiinBeBe'),
    #                 'checkpt-%04d.pth' % 10000))

    #checkpoint2 = torch.load(
    #    os.path.join(os.path.join(args.save, '000000000000mmmmmmmmmmaaaiinnNikNik99MaaiiinMaaiiinBeBe'),
    #                 'checkpt-%04d.pth' % 10000))

    #checkpoint2 = torch.load(
    #    os.path.join(os.path.join(args.save, '0000000000000mmmmmmmmmmmaaaiinnNikNik99MaaiiinMaaiiinBeBe'),
    #                 'checkpt-%04d.pth' % 10000))

    #checkpoint2 = torch.load(
    #    os.path.join(os.path.join(args.save, '00000000000000mmmmmmmmmmmmaaaiinnNikNik99MaaiiinMaaiiinBeBe'),
    #                 'checkpt-%04d.pth' % 10000))

    #checkpoint2 = torch.load(
    #    os.path.join(os.path.join(args.save, '000000000000000mmmmmmmmmmmmmaaaiinnNikNik99MaaiiinMaaiiinBeBe'),
    #                 'checkpt-%04d.pth' % 10000))
        ...
        for i, (x, y) in enumerate(train_loader):
            ...
            if lossGen < best_loss:
                ...
                utils.save_checkpoint(
                    {'state_dict': genGen.state_dict(), 'optimizer_state_dict': optimizerGen.state_dict(),
                     'args': args},
                    os.path.join(args.save, '000000000000000000mmmmmmmmmmmmmmmmaaaiinnNikNik99MaaiiinMaaiiinBeBe'), args.nepochs)
            ...
            if (itr - 1) % 1000 == 0:
                ...
                utils.save_checkpoint(
                    {'state_dict': genGen.state_dict(), 'optimizer_state_dict': optimizerGen.state_dict(),
                     'args': args},
                    os.path.join(args.save, '00000000000000000mmmmmmmmmmmmmmmmaaaiinnNikNik99MaaiiinMaaiiinBe2Be2'), args.nepochs)
