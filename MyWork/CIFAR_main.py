...
#parser.add_argument('--resume', default='./myWork/IResNetModel_198.t7', type=str, metavar='PATH',
#                    help='path to latest checkpoint (default: none)')

#parser.add_argument('--resume', default='./myWork/IResNetModel_198.t7', type=str, metavar='PATH',
#                    help='path to latest checkpoint (default: none)')

parser.add_argument('--resume', default='./onlyWork/IResNetModelGM_10.t7', type=str, metavar='PATH',
                    help='path to latest checkpoint (default: none)')
...
#parser.add_argument('--save_dir', default=None, type=str, help='directory to save results')
#parser.add_argument('--save_dir', default='./myWork/', type=str, help='directory to save results')

#parser.add_argument('--save_dir', default='./myWork/', type=str, help='directory to save results')
parser.add_argument('--save_dir', default='./onlyWork/', type=str, help='directory to save results')

#parser.add_argument('--save_dir', default=None, type=str, help='directory to save results')
#parser.add_argument('--vis_port', default=8097, type=int, help="port for visdom")

#parser.add_argument('--vis_port', default=8097, type=int, help="port for visdom")
parser.add_argument('--vis_port', default=7888, type=int, help="port for visdom")
