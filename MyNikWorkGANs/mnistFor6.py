...
#parser.add_argument('--resume', type=str, default='./experiment1/forFor8For8For8ModeFor8Models/moMosFor8For8FoFor8For8MostReceFor8reRecent.pth')
#parser.add_argument('--resume', type=str, default='./experiment1/for8for8For8For8For8ModeFor8Models/for8for8For8FoFor8For8MostReceFor8reRecent.pth')

#parser.add_argument('--resume', type=str, default='./finalExpFor1/foFoFoFoFoForFor1_foFoForFor1_foFor1most_for1RRRecent.pth')

#parser.add_argument('--resume', type=str, default='./finalExpFor1/foFoFoFoFoForFor1_foFoForFor1_foFor1most_for1RRRecent.pth')
#parser.add_argument('--resume', type=str, default='./experiment1/moMoMoFor2For2_modeModels/nikFor2CopyFor2recent.pth')

#parser.add_argument('--resume', type=str, default='./finalExpFor1/foFoFoFoFoForFor1_foFoForFor1_foFor1most_for1RRRecent.pth')
#parser.add_argument('--resume', type=str, default='./expFor8/03030330201mosMost_recent.pth')

#parser.add_argument('--resume', type=str, default='./expFor8/03030330201mosMost_recent.pth')

#parser.add_argument('--resume', type=str, default='./expFor8/03030330201mosMost_recent.pth')
#parser.add_argument('--resume', type=str, default='./expFor6/00mostReRecent.pth')

#parser.add_argument('--resume', type=str, default='./expFor6/00mostReRecent.pth')
#parser.add_argument('--resume', type=str, default='./presPresPresGAN/presgan_lambda_0.01/netG_presgan_mnist_epoch_3.pth')
...
#parser.add_argument('--resume', type=str, default='./presPresPresGAN/presgan_lambda_0.0001/netG_presgan_mnist_epoch_3.pth')
parser.add_argument('--resume', type=str, default='./presPresPresGAN/presgan_lambda_0.01/netG_presgan_mnist_epoch_3.pth')

#parser.add_argument('--resume', type=str, default='./experiment1/moMoMoFor2For2_modeModels/nikFor2CopyFor2recent.pth')
#parser.add_argument('--resume', type=str, default='./experiment1/moMoMoFor2For2_modeModels/nikfor2for2CopyFor2recent.pth')

#parser.add_argument('--resume', type=str, default='./ciCifaCifarFor0/mostFoFor0For0For0For0_reFor0For0FoFor0For0reRecent.pth')

#parser.add_argument('--resume', type=str, default='./ciCifaCifarFor0/mostFoFor0For0For0For0_reFor0For0FoFor0For0reRecent.pth')
#parser.add_argument('--resume', type=str, default='./experiment1/moMoMoFor0theModels/nikFor0For0recent.pth')
...
#parser.add_argument('--resume', type=str, default='./fromEddie_expFor2/00for5_for5_55000mostReRecent.pth')
#parser.add_argument('--resume', type=str, default='./finalExpFor4/foFoFoFoForFor4_foForFor4_moMoForMoFor4_mosstReeccent.pth')

# os.path.join(args.save, 'moMoMoFor0theModels', 'nikFor0For0recent.pth'))
# use: os.path.join(args.save, 'moMoMoFor0theModels', 'nikFor0For0recent.pth'))

# os.path.join(args.save, 'moMoMoForr0_modeModels', 'nikCopyForr0Forr0recent.pth'))
# use: os.path.join(args.save, 'moMoMoForr0_modeModels', 'nikCopyForr0Forr0recent.pth'))

# os.path.join(args.save, 'moMoMoFor2For2_modeModels', 'nikfor2for2CopyFor2recent.pth'))
# use: os.path.join(args.save, 'moMoMoFor2For2_modeModels', 'nikfor2for2CopyFor2recent.pth'))
...
# os.path.join(args.save, 'moMoMoFor2For2_modeModels', 'nikFor2CopyFor2recent.pth'))
# use: os.path.join(args.save, 'moMoMoFor2For2_modeModels', 'nikFor2CopyFor2recent.pth'))

# os.path.join(args.save, 'for8for8For8For8For8ModeFor8Models', 'for8for8For8FoFor8For8MostReceFor8reRecent.pth'))
# use: os.path.join(args.save, 'for8for8For8For8For8ModeFor8Models', 'for8for8For8FoFor8For8MostReceFor8reRecent.pth'))
...
if args.data == 'cifar10':
    ...
    train_trainLoader = datasets.MNIST(
    ...
    train_trainLoader2 = datasets.MNIST(
        args.dataroot, train=True, transform=transforms.Compose([
            transforms.Resize(args.imagesize),
            transforms.ToTensor(),
            add_noise,
    ...
    idx = train_trainLoader.mnist.targets == 0
    train_trainLoader.mnist.targets = train_trainLoader.mnist.targets[idx]
    train_trainLoader.mnist.data = train_trainLoader.mnist.data[idx]
    ...
    idx = train_trainLoader2.mnist.targets == 2
    train_trainLoader2.mnist.targets = train_trainLoader2.mnist.targets[idx]
    train_trainLoader2.mnist.data = train_trainLoader2.mnist.data[idx]
    ...
    idx = train_trainLoader2.mnist.targets == 3
    train_trainLoader2.mnist.targets = train_trainLoader2.mnist.targets[idx]
    train_trainLoader2.mnist.data = train_trainLoader2.mnist.data[idx]
    ...
    idx = train_trainLoader2.mnist.targets == 4
    train_trainLoader2.mnist.targets = train_trainLoader2.mnist.targets[idx]
    train_trainLoader2.mnist.data = train_trainLoader2.mnist.data[idx]
    ...
    idx = train_trainLoader2.mnist.targets == 5
    train_trainLoader2.mnist.targets = train_trainLoader2.mnist.targets[idx]
    train_trainLoader2.mnist.data = train_trainLoader2.mnist.data[idx]
    ...
    idx = train_trainLoader2.mnist.targets == 6
    train_trainLoader2.mnist.targets = train_trainLoader2.mnist.targets[idx]
    train_trainLoader2.mnist.data = train_trainLoader2.mnist.data[idx]
    ...
    idx = train_trainLoader2.mnist.targets == 7
    train_trainLoader2.mnist.targets = train_trainLoader2.mnist.targets[idx]
    train_trainLoader2.mnist.data = train_trainLoader2.mnist.data[idx]
    ...
    idx = train_trainLoader2.mnist.targets == 8
    train_trainLoader2.mnist.targets = train_trainLoader2.mnist.targets[idx]
    train_trainLoader2.mnist.data = train_trainLoader2.mnist.data[idx]
    ...
    idx = train_trainLoader2.mnist.targets == 9
    train_trainLoader2.mnist.targets = train_trainLoader2.mnist.targets[idx]
    train_trainLoader2.mnist.data = train_trainLoader2.mnist.data[idx]
