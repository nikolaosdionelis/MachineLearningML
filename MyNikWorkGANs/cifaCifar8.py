...
#parser.add_argument('--resume', type=str, default=None)
#parser.add_argument('--resume', type=str, default='./experiment1/moFor8For8_ModeModels/checkpt-0000.pth')

#parser.add_argument('--resume', type=str, default='./experiment1/moFor8For8_ModeModels/checkpt-0000.pth')

#parser.add_argument('--resume', type=str, default='./experiment1/moFor8For8_ModeModels/checkpt-0000.pth')
parser.add_argument('--resume', type=str, default='./experiment1/moFor9For9_ModeModels/checkpt-0000.pth')

# os.path.join(args.save, 'moFor9For9_ModeModels', 'checkpt-0000.pth'))
# use: os.path.join(args.save, 'moFor9For9_ModeModels', 'checkpt-0000.pth'))
    ...
    for epoch in range(args.begin_epoch, args.nepochs):
        ...
        if test_bpd < best_test_bpd:
            ...
            utils.save_checkpoint({
                ...
                'ema': ema,
                'test_bpd': test_bpd,
            }, os.path.join(args.save, 'moFor9For9_ModeModels'), epoch, last_checkpoints, num_checkpoints=5)
        ...
        #    'ema': ema,
        #    'test_bpd': test_bpd,
        #}, os.path.join(args.save, 'moFor9For9_ModeModels', 'moMosFoFor9ForFor9_MostReceReRecent.pth'))
        ...
        torch.save({
            ...
            'ema': ema,
            'test_bpd': test_bpd,
        }, os.path.join(args.save, 'moFor9For9_ModeModels', 'moMosFoForFor9ForFor9_MostReceReRecent.pth'))
