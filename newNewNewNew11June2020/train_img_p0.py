...
# --data mnist --imagesize 28 --actnorm True --wd 0 --save experiments/mnist
...
parser.add_argument('--save', help='directory to save results', type=str, default='experimentMNIST')
