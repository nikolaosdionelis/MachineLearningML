...
#parser.add_argument('--val-batchsize', help='minibatch size', type=int, default=200)
parser.add_argument('--val-batchsize', help='minibatch size', type=int, default=256)
...
#parser.add_argument('--resume', type=str, default='./experiment1/models/theTheTheTheTheTheTheTheMostRecent.pth')
#parser.add_argument('--resume', type=str, default='./models/theTheTheTheTheTheTheTheMostRecent.pth')
...
def main():
    ...
    checkpoint2 = torch.load(
        os.path.join(os.path.join(args.save, 'maainMaainMaainMyMyMyBest'), 'checkpt-%04d.pth' % args.nepochs))
    ...
    #checkpoint2 = torch.load(
    #    os.path.join(os.path.join(args.save, 'maaiiinMaaiiinMyMyMyMyMyBeBest'), 'checkpt-%04d.pth' % args.nepochs))

    #checkpoint2 = torch.load(os.path.join(os.path.join(args.save, 'maaiiinMaaiiinMyMyMyMyMyBeBest'), 'checkpt-%04d.pth' % args.nepochs))
    #checkpoint2 = torch.load(os.path.join(os.path.join(args.save, 'maaiiinMaaiiinMyMyMyBest9'), 'checkpt-%04d.pth' % args.nepochs))

    #checkpoint2 = torch.load(
    #    os.path.join(os.path.join(args.save, 'maaiiinMaaiiinMyMyMyBest9'), 'checkpt-%04d.pth' % args.nepochs))
    ...
    #checkpoint2 = torch.load(
    #    os.path.join(os.path.join(args.save, 'maaiiinNikNik99MaaiiinMaaiiinBest'), 'checkpt-%04d.pth' % args.nepochs))
    ...
    lossTestInferenceLoss = 0.0
    lossTestInferenceLoss0 = 0.0

    lossTestInferenceLoss1 = 0.0
    counterCountMain = 0
    ...
    for itr in range(1, 10 + 1):
        ...
        for i, (x, y) in enumerate(test_loader):
            ...
            #ggenFGen2 = torch.randn([args.batchsize, nrand], device=device, requires_grad=True)
            ggenFGen2 = torch.randn([args.batchsize, nrand], device=device, requires_grad=False)
            ...
            lossTestInferenceLoss += lossGen
            lossTestInferenceLoss0 += firstOnly_lossGen
            lossTestInferenceLoss1 += secondOnly_lossGen
    ...
    print('')
    print(counterCountMain)
    print(lossTestInferenceLoss / counterCountMain)

    print(lossTestInferenceLoss0 / counterCountMain)
    print(lossTestInferenceLoss1 / counterCountMain)
