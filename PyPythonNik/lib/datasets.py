...
class FashionMNIST(object):
    ...
    def __init__(self, dataroot, train=True, transform=None):
        self.fashionmnist = vdsets.FashionMNIST(dataroot, train=train, download=True, transform=transform)
    ...
    def __getitem__(self, index):
        return self.fashionmnist[index]
...
class SVHN(object):
    ...
    def __init__(self, dataroot, split='train', transform=None):
        self.svhn = vdsets.SVHN(dataroot, split='train', download=True, transform=transform)
    ...
    def __getitem__(self, index):
        return self.svhn[index]


class CIFAR100(object):

    def __init__(self, dataroot, train=True, transform=None):
        self.cifar100 = vdsets.CIFAR100(dataroot, train=train, download=True, transform=transform)
