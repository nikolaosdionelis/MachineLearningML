...
#parser.add_argument('--save', help='directory to save results', type=str, default='experiment1')
parser.add_argument('--save', help='directory to save results', type=str, default='eExperiments/mnist')
...
#parser.add_argument('--resume', type=str, default='./expExperiments/mnist/models/most_recent.pth')
...
#parser.add_argument('--resume', type=str, default=None)
#parser.add_argument('--resume', type=str, default='./cifar10-iresnet/resFlows/eExperiments/mnist/moModels/checkpt-0000.pth')

#parser.add_argument('--resume', type=str, default='./cifar10-iresnet/resFlows/eExperiments/mnist/moModels/checkpt-0000.pth')
#parser.add_argument('--resume', type=str, default='./eExperiments/mnist/moModels/checkpt-0000.pth')

#parser.add_argument('--resume', type=str, default='./eExperiments/mnist/moModels/checkpt-0000.pth')
#parser.add_argument('--resume', type=str, default='./eExperiments/mnist/mModels/mostRecent.pth')

#parser.add_argument('--resume', type=str, default='./eExperiments/mnist/mModels/mostRecent.pth')
#parser.add_argument('--resume', type=str, default='./eExperiments/mnist/mmMModels/mostReRecent.pth')
...
#parser.add_argument('--resume', type=str, default='./eExperiments/mnist/mmMModels/mostReRecent.pth')
#parser.add_argument('--resume', type=str, default='./eExperiments/mnist/mmMModels/mostReReRecent.pth')

#parser.add_argument('--resume', type=str, default='./eExperiments/mnist/mmMModels/mostReReRecent.pth')
#parser.add_argument('--resume', type=str, default='./eExperiments/mnist/mmmMModels/mostReReReRecent.pth')

#parser.add_argument('--resume', type=str, default='./eExperiments/mnist/mmmMModels/mostReReReRecent.pth')
#parser.add_argument('--resume', type=str, default='./eExperiments/mnist/mmmMModels/mostReReReReRecent.pth')
...
#parser.add_argument('--resume', type=str, default='./eExperiments/mnist/mmmMModels/mostReReReReRecent.pth')
parser.add_argument('--resume', type=str, default='./eExperiments/mnist/mmmmMModels/mostReReReReReRecent.pth')
...
def main():
    ...
    for epoch in range(args.begin_epoch, args.nepochs):
        ...
        if test_bpd < best_test_bpd:
            ...
            #    'ema': ema,
            #    'test_bpd': test_bpd,
            #}, os.path.join(args.save, 'moModels'), epoch, last_checkpoints, num_checkpoints=5)
            ...
            #    'ema': ema,
            #    'test_bpd': test_bpd,
            #}, os.path.join(args.save, 'mmMModels'), epoch, last_checkpoints, num_checkpoints=5)
            ...
            #    'ema': ema,
            #    'test_bpd': test_bpd,
            #}, os.path.join(args.save, 'mmmMModels'), epoch, last_checkpoints, num_checkpoints=5)
            ...
            #    'ema': ema,
            #    'test_bpd': test_bpd,
            #}, os.path.join(args.save, 'mmmmMModels'), epoch, last_checkpoints, num_checkpoints=5)
            ...
            utils.save_checkpoint({
                ...
                'ema': ema,
                'test_bpd': test_bpd,
            }, os.path.join(args.save, 'mmmmmMModels'), epoch, last_checkpoints, num_checkpoints=5)
        ...
        #    'ema': ema,
        #    'test_bpd': test_bpd,
        #}, os.path.join(args.save, 'mModels', 'mostRecent.pth'))
        ...
        #    'ema': ema,
        #    'test_bpd': test_bpd,
        #}, os.path.join(args.save, 'mmMModels', 'mostReRecent.pth'))
        ...
        #    'ema': ema,
        #    'test_bpd': test_bpd,
        #}, os.path.join(args.save, 'mmMModels', 'mostReReRecent.pth'))
        ...
        #    'ema': ema,
        #    'test_bpd': test_bpd,
        #}, os.path.join(args.save, 'mmmMModels', 'mostReReReRecent.pth'))
        ...
        #    'ema': ema,
        #    'test_bpd': test_bpd,
        #}, os.path.join(args.save, 'mmmMModels', 'mostReReReReRecent.pth'))
        ...
        #    'ema': ema,
        #    'test_bpd': test_bpd,
        #}, os.path.join(args.save, 'mmmmMModels', 'mostReReReReReRecent.pth'))
        ...
        torch.save({
            ...
            'ema': ema,
            'test_bpd': test_bpd,
        }, os.path.join(args.save, 'mmmmmMModels', 'mostReReReReReReRecent.pth'))
