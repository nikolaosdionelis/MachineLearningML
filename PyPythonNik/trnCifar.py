...
# parser.add_argument('--batch_sizeM', help='Minibatch size', type=int, default=512)
# parser.add_argument('--batch_sizeM', help='Minibatch size', type=int, default=256)
...
#parser.add_argument('--resume', type=str, default='./expsPretrained/mnist_resflow_16-16-16.pth')
parser.add_argument('--resume', type=str, default='./expsPretrained/cifar10_resflow_16-16-16.pth')
...
if args.data == 'cifar10':
    ...
    myTrain_loader = datasets.CIFAR10(args.dataroot, train=True, transform=transform_train)

    """
    evens = list(range(0, len(myTrain_loader), 2))
    myTrain_loader = torch.utils.data.Subset(myTrain_loader, evens)
    ...
    myTest_loader = datasets.CIFAR10(args.dataroot, train=False, transform=transform_test)

    evens = list(range(0, len(myTest_loader), 2))
    myTest_loader = torch.utils.data.Subset(myTest_loader, evens)
    ...
    myTest2_loader = datasets.CIFAR100(args.dataroot, train=False, transform=transform_test)
    #myTest2_loader = datasets.SVHN(args.dataroot, split='train', transform=transform_test)

    evens = list(range(0, len(myTest2_loader), 2))
    myTest2_loader = torch.utils.data.Subset(myTest2_loader, evens)
    ...
    # use test_loader and test2_loader
    # we use test_loader and test2_loader
...
def main():
    ...
    for itr in range(1, 1 + 1):
        ...
        # for i, (x, y) in enumerate(train_loader):
        for i, (x, y) in enumerate(test2_loader):
            # x = x.to(device)
    ...
    def plot_roc_curve(fpr, tpr, auroc21):
        ...
        plt.savefig('77655000nik0000000NikNikROC_MainROC.png', bbox_inches='tight')
    ...
    def plot_pr_curve(fpr, tpr, auroc21):
        ...
        #plt.savefig('nik000NikNikPR_MainPR.png', bbox_inches='tight')
        #plt.savefig('nik00000NikNikPR_MainPR.png', bbox_inches='tight')
        plt.savefig('77655000nik0000000NikNikPR_MainPR.png', bbox_inches='tight')
    ...
    def plot_roc_curve2(fpr, tpr, auroc21, fpr2, tpr2, auroc212):
        ...
        #plt.savefig('nikNik00000nikNikNikROC_MainROC.png', bbox_inches='tight')
        #plt.savefig('655000nikNik00000nikNikNikROCPR_MainROCPR.png', bbox_inches='tight')
        plt.savefig('77655000nikNik00000nikNikNikROCPR_MainROCPR.png', bbox_inches='tight')
