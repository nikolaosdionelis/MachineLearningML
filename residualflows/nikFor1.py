...
# use: experiments/mnist
parser.add_argument('--save', help='directory to save results', type=str, default='experiments/mnist')
...
#parser.add_argument('--resume', type=str, default=None)
#parser.add_argument('--resume', type=str, default='./for1_notFinished/checkpt-0000.pth')

#parser.add_argument('--resume', type=str, default=None)
#parser.add_argument('--resume', type=str, default='./experiments/mnist/models/foFoFoForFor1_fFor1_for1most_for1RRRecent.pth')
...
if args.data == 'cifar10':
    ...
    #idx += train_trainLoader.mnist.targets == 1
    idx += train_trainLoader.mnist.targets == 2
    idx += train_trainLoader.mnist.targets == 3
    idx += train_trainLoader.mnist.targets == 4
    idx += train_trainLoader.mnist.targets == 5
    idx += train_trainLoader.mnist.targets == 6
    idx += train_trainLoader.mnist.targets == 7
    idx += train_trainLoader.mnist.targets == 8
    idx += train_trainLoader.mnist.targets == 9
...
def main():
    ...
    for epoch in range(args.begin_epoch, args.nepochs):
        ...
        #    'ema': ema,
        #    'test_bpd': test_bpd,
        #}, os.path.join(args.save, 'models', '000mostReRecent.pth'))
        ...
        #    'ema': ema,
        #    'test_bpd': test_bpd,
        #}, os.path.join(args.save, 'models', '00for5_for5_55000mostReRecent.pth'))
        ...
        #    'ema': ema,
        #    'test_bpd': test_bpd,
        #}, os.path.join(args.save, 'models', '56for5_785700for5_for5_55000mostReRecent.pth'))
        ...
        #    'ema': ema,
        #    'test_bpd': test_bpd,
        #}, os.path.join(args.save, 'models', '000for7_for7mostReRecent.pth'))
        ...
        #    'ema': ema,
        #    'test_bpd': test_bpd,
        #}, os.path.join(args.save, 'models', '000foFor7_for7mostReReRecent.pth'))
        ...
        #    'ema': ema,
        #    'test_bpd': test_bpd,
        #}, os.path.join(args.save, 'models', 'foForFor1_fFor1_for1most_for1RRRecent.pth'))
        ...
        #    'ema': ema,
        #    'test_bpd': test_bpd,
        #}, os.path.join(args.save, 'models', 'foFoFoForFor1_fFor1_for1most_for1RRRecent.pth'))
        ...
        torch.save({
            ...
            'ema': ema,
            'test_bpd': test_bpd,
        }, os.path.join(args.save, 'models', 'foFoFoFoFoForFor1_foFoForFor1_foFor1most_for1RRRecent.pth'))
