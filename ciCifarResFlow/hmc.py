...
def get_samples(netG, x_tilde, eps_init, sigma, burn_in, num_samples_posterior, 
    ...
    for i in range(n_steps):
        ...
        #print(accept.float().mean().item())
        #asdfasdfs

        #print(proposed_U)
        #print(current_U)

        #print(torch.exp(current_U - proposed_U + current_K - proposed_K).mean())

        #print(p.mean())
        #print(current_p.mean())
        ...
        #print(proposed_U.mean())
        #print(current_U.mean())

        #print(torch.exp(proposed_U).mean())
        #print(torch.exp(current_U).mean())

        #print(torch.exp(proposed_K).mean())
        #print(torch.exp(current_K).mean())
