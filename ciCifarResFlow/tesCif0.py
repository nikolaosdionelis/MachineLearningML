...
#parser.add_argument('--resume', type=str, default='./experiment1/for8Mdls/for8nt.pth')
#parser.add_argument('--resume', type=str, default='./experiment1/for8mdlsMdls/for8ntnt.pth')
...
# use: os.path.join(args.save, 'for8mdlsMdls', 'for8ntnt.pth'))
...
def main():
    ...
    def plot_roc_curve(fpr, tpr, auroc21):
        ...
        # plt.savefig('nik000NikNikROC_MainROC.png', bbox_inches='tight')
        plt.savefig('ciCifarFor0MyROC.png', bbox_inches='tight')
    ...
    def plot_pr_curve(fpr, tpr, auroc21):
        ...
        # plt.savefig('nik000NikNikPR_MainPR.png', bbox_inches='tight')
        plt.savefig('ciCifarFor0MyPR.png', bbox_inches='tight')
    ...
    def plot_roc_curve2(fpr, tpr, auroc21, fpr2, tpr2, auroc212):
        ...
        # plt.savefig('nikNik00000nikNikNikROC_MainROC.png', bbox_inches='tight')
        plt.savefig('ciCifarFor0MyROCPR.png', bbox_inches='tight')
