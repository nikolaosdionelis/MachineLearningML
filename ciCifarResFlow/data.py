...
def create_data(name, data_path, batch_size, device, imgsize, Ntrain, Ntest, n_mixtures, radius, std):
    if name == 'ring':
        ...
        train_loader = DataLoader(mnist, batch_size=1, shuffle=True, drop_last=True, num_workers=args.workers)
        ...
        test_loader = DataLoader(mnist, batch_size=1, shuffle=False, drop_last=True, num_workers=args.workers)
