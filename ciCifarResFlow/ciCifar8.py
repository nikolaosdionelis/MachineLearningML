...
if args.data == 'cifar10':
    ...
    idx = torch.tensor(train_trainLoader.cifar10.targets) == 0
    ...
    idx = torch.tensor(train_trainLoader2.cifar10.targets) == 1
...
def main():
    ...
    for epoch in range(args.begin_epoch, args.nepochs):
        ...
        torch.save({
            ...
            'ema': ema,
            'test_bpd': test_bpd,
        }, os.path.join(args.save, 'for8for8For8For8For8ModeFor8Models', 'for8for8For8FoFor8For8MostReceFor8reRecent.pth'))
