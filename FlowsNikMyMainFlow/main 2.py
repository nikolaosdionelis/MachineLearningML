...
parser.add_argument('--save_ckpt_every', type=int, default=800, help='when to save checkpoint')
parser.add_argument('--save_imgs_every', type=int, default=800, help='when to save generated images')
