...
#flags.DEFINE_string("checkpoint_dir", "checkpoint", "Directory name to save the checkpoints [checkpoint]")
flags.DEFINE_string("checkpoint_dir", "checkpointMniMnist/flow", "Directory name to save the checkpoints [checkpoint]")
...
#flags.DEFINE_string("sample_dir", "samples", "Directory name to save the image samples [samples]")
flags.DEFINE_string("sample_dir", "samplesMniMnist/flow", "Directory name to save the image samples [samples]")
...
#flags.DEFINE_string("log_dir", "logs_mnist/flow", "Directory name to save the logs [logs]")
flags.DEFINE_string("loLog_dir", "logsMniMnist/flow", "Directory name to save the logs [logs]")
