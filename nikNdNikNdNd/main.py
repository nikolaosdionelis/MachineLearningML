...
# main.py --dataset cifar10 --model presgan --lambda 0.0002
# use: main.py --dataset cifar10 --model presgan --lambda 0.0002
...
###### Data arguments
#parser.add_argument('--dataset', default='cifar10', help=' ring | mnist | stackedmnist | cifar10 | celeba')
parser.add_argument('--dataset', default='mnist', help=' ring | mnist | stackedmnist | cifar10 | celeba')
...
#parser.add_argument('--lambda_', type=float, default=0.01, help='entropy coefficient')
parser.add_argument('--lambda_', type=float, default=0.0002, help='entropy coefficient')
