...
parser.add_argument('--nblocks', type=str, default='32-32-32')
...
#parser.add_argument('--batchsize', help='Minibatch size', type=int, default=32)
parser.add_argument('--batchsize', help='Minibatch size', type=int, default=16)
...
#parser.add_argument('--resume', type=str, default='./experiment1/models/most_recent.pth')
#parser.add_argument('--resume', type=str, default='./experiment1/modeModels/mostRecent.pth')

#parser.add_argument('--resume', type=str, default='./experiment1/modeModels/mostRecent.pth')
#parser.add_argument('--resume', type=str, default=None)

#parser.add_argument('--resume', type=str, default=None)
#parser.add_argument('--resume', type=str, default='./experiment1/moFor8_ModeModels/moMosFor8_MostReceRecent.pth')
...
#parser.add_argument('--resume', type=str, default='./experiment1/moFor8For8_ModeModels/moMosFoFor8For8_MostReceReRecent.pth')
#parser.add_argument('--resume', type=str, default='./experiment1/moFor8For8_ModeModels/moMosFoFor8For8_MostReceFor8_reRecent.pth')
...
#parser.add_argument('--resume', type=str, default='./experiment1/moFor8For8_ModeModels/moMosFoFor8For8_MostReceReRecent.pth')
#parser.add_argument('--resume', type=str, default='./experiment1/moFor8For8For8_ModeModels/moMosFor8FoFor8For8_MostReceFor8_reRecent.pth')

#parser.add_argument('--resume', type=str, default='./experiment1/moFor8For8For8_ModeModels/moMosFor8FoFor8For8_MostReceFor8_reRecent.pth')
#parser.add_argument('--resume', type=str, default='./experiment1/moFor8For8For8ModeFor8Models/checkpt-0000.pth')

#parser.add_argument('--resume', type=str, default='./experiment1/moFor8For8For8_ModeModels/moMosFor8FoFor8For8_MostReceFor8_reRecent.pth')

#parser.add_argument('--resume', type=str, default='./experiment1/moFor8For8For8_ModeModels/moMosFor8FoFor8For8_MostReceFor8_reRecent.pth')
#parser.add_argument('--resume', type=str, default='./experiment1/forFor8For8For8ModeFor8Models/moMosFor8For8FoFor8For8MostReceFor8reRecent.pth')

#parser.add_argument('--resume', type=str, default='./experiment1/forFor8For8For8ModeFor8Models/moMosFor8For8FoFor8For8MostReceFor8reRecent.pth')
#parser.add_argument('--resume', type=str, default=None)

#parser.add_argument('--resume', type=str, default=None)
parser.add_argument('--resume', type=str, default='./experiment1/for8Mdls/for8nt.pth')

# os.path.join(args.save, 'for8Mdls', 'for8nt.pth'))
# use: os.path.join(args.save, 'for8Mdls', 'for8nt.pth'))

# os.path.join(args.save, 'forFor8For8For8ModeFor8Models', 'moMosFor8For8FoFor8For8MostReceFor8reRecent.pth'))
# use: os.path.join(args.save, 'forFor8For8For8ModeFor8Models', 'moMosFor8For8FoFor8For8MostReceFor8reRecent.pth'))

# os.path.join(args.save, 'moFor8For8For8ModeFor8Models', 'moMosFor8For8FoFor8For8MostReceFor8reRecent.pth'))
# use: os.path.join(args.save, 'moFor8For8For8ModeFor8Models', 'moMosFor8For8FoFor8For8MostReceFor8reRecent.pth'))

# os.path.join(args.save, 'moFor8For8For8_ModeModels', 'moMosFor8FoFor8For8_MostReceFor8_reRecent.pth'))
# use: os.path.join(args.save, 'moFor8For8For8_ModeModels', 'moMosFor8FoFor8For8_MostReceFor8_reRecent.pth'))
...
# os.path.join(args.save, 'moFor8For8_ModeModels', 'moMosFoFor8For8_MostReceFor8_reRecent.pth'))
# use: os.path.join(args.save, 'moFor8For8_ModeModels', 'moMosFoFor8For8_MostReceFor8_reRecent.pth'))
...
# os.path.join(args.save, 'moFor8_ModeModels', 'moMosFoFor8_MostReceReRecent.pth'))
# use: os.path.join(args.save, 'moFor8_ModeModels', 'moMosFoFor8_MostReceReRecent.pth'))

# os.path.join(args.save, 'moFor8_ModeModels', 'moMosFor8_MostReceRecent.pth'))
# use: os.path.join(args.save, 'moFor8_ModeModels', 'moMosFor8_MostReceRecent.pth'))

# os.path.join(args.save, 'modeModels', 'mostRecent.pth'))
# use: os.path.join(args.save, 'modeModels', 'mostRecent.pth'))

# os.path.join(args.save, 'modeModels', 'mostRecent.pth'))
# use: os.path.join(args.save, 'modeModels', 'mostRecent.pth'))

# use: parser.add_argument('--resume', type=str, default='./experiment1/moModels/foFor6_mosRecenFor6.pth')
# we use: parser.add_argument('--resume', type=str, default='./experiment1/moModels/foFor6_mosRecenFor6.pth')

# os.path.join(args.save, 'models', 'most_recent.pth'))
# use: os.path.join(args.save, 'models', 'most_recent.pth'))
...
if args.data == 'cifar10':
    ...
    train_trainLoader = datasets.CIFAR10(args.dataroot, train=True, transform=transform_train)
    train_trainLoader2 = datasets.CIFAR10(args.dataroot, train=True, transform=transform_train)

    idx = torch.tensor(train_trainLoader.cifar10.targets) == 1
    train_trainLoader = torch.utils.data.dataset.Subset(train_trainLoader, np.where(idx == 1)[0])
    ...
    idx = torch.tensor(train_trainLoader2.cifar10.targets) == 2
    train_trainLoader2 = torch.utils.data.dataset.Subset(train_trainLoader2, np.where(idx == 1)[0])
    # train_trainLoader2.mnist.train_data = train_trainLoader2.mnist.train_data[idx]

    evens = list(range(0, len(train_trainLoader2), 2))
    train_trainLoader2 = torch.utils.data.Subset(train_trainLoader2, evens)
    ...
    train_trainLoader = torch.utils.data.ConcatDataset([train_trainLoader, train_trainLoader2])

    train_trainLoader2 = datasets.CIFAR10(args.dataroot, train=True, transform=transform_train)

    idx = torch.tensor(train_trainLoader2.cifar10.targets) == 3
    train_trainLoader2 = torch.utils.data.dataset.Subset(train_trainLoader2, np.where(idx == 1)[0])
    # train_trainLoader2.mnist.train_data = train_trainLoader2.mnist.train_data[idx]
    ...
    idx = torch.tensor(train_trainLoader2.cifar10.targets) == 4
    train_trainLoader2 = torch.utils.data.dataset.Subset(train_trainLoader2, np.where(idx == 1)[0])
    # train_trainLoader2.mnist.train_data = train_trainLoader2.mnist.train_data[idx]
    ...
    idx = torch.tensor(train_trainLoader2.cifar10.targets) == 5
    train_trainLoader2 = torch.utils.data.dataset.Subset(train_trainLoader2, np.where(idx == 1)[0])
    # train_trainLoader2.mnist.train_data = train_trainLoader2.mnist.train_data[idx]
    ...
    idx = torch.tensor(train_trainLoader2.cifar10.targets) == 6
    train_trainLoader2 = torch.utils.data.dataset.Subset(train_trainLoader2, np.where(idx == 1)[0])
    # train_trainLoader2.mnist.train_data = train_trainLoader2.mnist.train_data[idx]
    ...
    idx = torch.tensor(train_trainLoader2.cifar10.targets) == 7
    train_trainLoader2 = torch.utils.data.dataset.Subset(train_trainLoader2, np.where(idx == 1)[0])
    # train_trainLoader2.mnist.train_data = train_trainLoader2.mnist.train_data[idx]
    ...
    idx = torch.tensor(train_trainLoader2.cifar10.targets) == 8
    train_trainLoader2 = torch.utils.data.dataset.Subset(train_trainLoader2, np.where(idx == 1)[0])
    # train_trainLoader2.mnist.train_data = train_trainLoader2.mnist.train_data[idx]
    ...
    idx = torch.tensor(train_trainLoader2.cifar10.targets) == 9
    train_trainLoader2 = torch.utils.data.dataset.Subset(train_trainLoader2, np.where(idx == 1)[0])
    # train_trainLoader2.mnist.train_data = train_trainLoader2.mnist.train_data[idx]
    ...
    del train_trainLoader2

    #print(len(train_trainLoader))
    #asdfadsf
...
def main():
    ...
    for epoch in range(args.begin_epoch, args.nepochs):
        ...
        if test_bpd < best_test_bpd:
            ...
            #    'ema': ema,
            #    'test_bpd': test_bpd,
            #}, os.path.join(args.save, 'moFor8_ModeModels'), epoch, last_checkpoints, num_checkpoints=5)
            ...
            #    'ema': ema,
            #    'test_bpd': test_bpd,
            #}, os.path.join(args.save, 'moFor8For8_ModeModels'), epoch, last_checkpoints, num_checkpoints=5)
            ...
            #    'ema': ema,
            #    'test_bpd': test_bpd,
            #}, os.path.join(args.save, 'forFor8For8For8ModeFor8Models'), epoch, last_checkpoints, num_checkpoints=5)
            ...
            #    'ema': ema,
            #    'test_bpd': test_bpd,
            #}, os.path.join(args.save, 'for8for8For8For8For8ModeFor8Models'), epoch, last_checkpoints, num_checkpoints=5)
            ...
            #    'ema': ema,
            #    'test_bpd': test_bpd,
            #}, os.path.join(args.save, 'for8Mdls'), epoch, last_checkpoints,
            #    num_checkpoints=5)
            ...
            utils.save_checkpoint({
                ...
                'ema': ema,
                'test_bpd': test_bpd,
            }, os.path.join(args.save, 'for8mdlsMdls'), epoch, last_checkpoints,
                num_checkpoints=5)
        ...
        torch.save({
            ...
            'ema': ema,
            'test_bpd': test_bpd,
        }, os.path.join(args.save, 'for8mdlsMdls', 'for8ntnt.pth'))
