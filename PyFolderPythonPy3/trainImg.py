...
if args.data == 'cifar10':
    ...
    idx = torch.tensor(train_trainLoader2.cifar10.train_labels) == 2
    ...
    idx = torch.tensor(train_trainLoader2.cifar10.train_labels) == 3
    train_trainLoader2 = torch.utils.data.dataset.Subset(train_trainLoader2, np.where(idx == 1)[0])
    # train_trainLoader2.mnist.train_data = train_trainLoader2.mnist.train_data[idx]
    ...
    idx = torch.tensor(train_trainLoader2.cifar10.train_labels) == 4
    train_trainLoader2 = torch.utils.data.dataset.Subset(train_trainLoader2, np.where(idx == 1)[0])
    # train_trainLoader2.mnist.train_data = train_trainLoader2.mnist.train_data[idx]
    ...
    idx = torch.tensor(train_trainLoader2.cifar10.train_labels) == 5
    train_trainLoader2 = torch.utils.data.dataset.Subset(train_trainLoader2, np.where(idx == 1)[0])
    # train_trainLoader2.mnist.train_data = train_trainLoader2.mnist.train_data[idx]
    ...
    idx = torch.tensor(train_trainLoader2.cifar10.train_labels) == 6
    train_trainLoader2 = torch.utils.data.dataset.Subset(train_trainLoader2, np.where(idx == 1)[0])
    # train_trainLoader2.mnist.train_data = train_trainLoader2.mnist.train_data[idx]
    ...
    idx = torch.tensor(train_trainLoader2.cifar10.train_labels) == 7
    train_trainLoader2 = torch.utils.data.dataset.Subset(train_trainLoader2, np.where(idx == 1)[0])
    # train_trainLoader2.mnist.train_data = train_trainLoader2.mnist.train_data[idx]
    ...
    idx = torch.tensor(train_trainLoader2.cifar10.train_labels) == 8
    train_trainLoader2 = torch.utils.data.dataset.Subset(train_trainLoader2, np.where(idx == 1)[0])
    # train_trainLoader2.mnist.train_data = train_trainLoader2.mnist.train_data[idx]
    ...
    idx = torch.tensor(train_trainLoader2.cifar10.train_labels) == 9
    train_trainLoader2 = torch.utils.data.dataset.Subset(train_trainLoader2, np.where(idx == 1)[0])
    # train_trainLoader2.mnist.train_data = train_trainLoader2.mnist.train_data[idx]
