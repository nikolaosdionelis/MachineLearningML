...
#parser.add_argument('--resume', type=str, default='./experiment1/modeModels/mostRecent.pth')
#parser.add_argument('--resume', type=str, default='./experiment1/modeModels/checkpt-0003.pth')

#parser.add_argument('--resume', type=str, default='./experiment1/modeModels/checkpt-0003.pth')

#parser.add_argument('--resume', type=str, default='./experiment1/modeModels/checkpt-0003.pth')
#parser.add_argument('--resume', type=str, default='./experiment1/moMoModeModels/mosMostReceRecent.pth')

#parser.add_argument('--resume', type=str, default='./experiment1/moMoModeModels/mosMostReceRecent.pth')
parser.add_argument('--resume', type=str, default=None)

# os.path.join(args.save, 'moMoModeModels', 'mosMostReceRecent.pth'))
# use: os.path.join(args.save, 'moMoModeModels', 'mosMostReceRecent.pth'))
    ...
    for epoch in range(args.begin_epoch, args.nepochs):
        ...
        if test_bpd < best_test_bpd:
            ...
            utils.save_checkpoint({
                ...
                'ema': ema,
                'test_bpd': test_bpd,
            }, os.path.join(args.save, 'moMoModeFor0Models'), epoch, last_checkpoints, num_checkpoints=5)
