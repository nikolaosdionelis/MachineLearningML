...
# --prior gaussian --beta1 0.5 --learning_rate 1e-3 --lr_decay 0.99999
# --alpha 1e-7 --epoch 500 --batch_size 64 --like_reg 20.  --n_critic 5 --no_of_layers 8
...
#flags.DEFINE_string("checkpoint_dir", "checkpoint_mnist/flow", "Directory name to save the checkpoints [checkpoint]")
flags.DEFINE_string("checkpoint_dir", "checkpoint_cifar/flow", "Directory name to save the checkpoints [checkpoint]")
...
#flags.DEFINE_string("sample_dir", "samples", "Directory name to save the image samples [samples]")
flags.DEFINE_string("sample_dir", "samples_cifar/flow", "Directory name to save the image samples [samples]")
...
#flags.DEFINE_string("log_dir", "logs_mnist/flow", "Directory name to save the logs [logs]")
flags.DEFINE_string("loLog_dir", "logs_cifar/flow", "Directory name to save the logs [logs]")
